...
- Ben's review (09-25): a collapsible "What is the AUC?" note (callout-note, not a Go deeper box) where the lesson first uses the AUC: ROC curve, area, the probability reading, 0.5 vs 1, and what it doesn't give (the cut, the base rate). Source: Hanley & McNeil (1982), doi:10.1148/radiology.143.1.7063747 (Crossref-checked).
