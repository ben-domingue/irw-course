...
4. **The IMV: how much better, on a portable scale.** Turn each model's predictions into a coin of equivalent uncertainty; the IMV is the expected return on a bet placed with the better model's coin. It doesn't depend on prevalence, so it compares across datasets. It's always a comparison of two models. *(major)* Sources: Domingue, Rahal, Faul, Freese & Kanopka, the IMV (SocArXiv preprint, doi:10.31235/osf.io/gu3ap_v2); Domingue, Kanopka, Kapoor, Pohl & Chalmers (2024), *Psychometrika* 89(3), 1034–1054, doi:10.1007/s11336-024-09977-2. (Ben's own work: first person is natural here. "I'm going to tell you about my kool-aid but you don't have to drink it", c6 slide 8.)
...
- The IMV is Ben's own work. How much first person, and should the lesson cite the 89-dataset IMV comparison from c6 slide 21 (which source is that?)
