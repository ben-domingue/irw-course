...
- Idea 3 sources (checked 09-24; Ben agrees with the verdict and the guesses):
  ...
  - **Astronomy: likely, not yet confirmed.** Briggs, D. C., Alonzo, A. C., Schwab, C., & Wilson, M. (2006). Diagnostic assessment with ordered multiple-choice items. *Educational Assessment*, 11(1), 33–63, https://doi.org/10.1207/s15326977ea1101_2 (checked on Crossref). As far as I recall, the paper's worked example is the Earth in the Solar System, but it is closed access and no open copy shows the figure. Ben (Stanford access) or Derek Briggs can confirm that the five-level table is from this paper, and its figure number.
