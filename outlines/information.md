...
- **Go deeper** kept as a callout (Rasch and 2PL information from the second derivative; observed = expected; information as the variance of the weighted score; additivity from local independence). Problem 1 is now the 3PL information and its peak location.
